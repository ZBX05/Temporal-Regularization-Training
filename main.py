...
def main():
    ...
    parser.add_argument('--trtloss',type=int,default=1,help='Whether to use the Temporal Regularization Training method. Default: True.')
    ...
    parser.add_argument('--loss_epsilon',type=float,default=1e-5,help='Hyperparameter of TRT: safegaurd value. Default: 1e-5.')
    parser.add_argument('--loss_eta',type=float,default=0.05,help='Hyperparameter of TRT: loss-ratio factor. Default: 0.05.')
    ...
    parser.add_argument('--amp',type=int,default=1,help='Whether to use automatic mixed precision training (to save memory). Default: True.')
    ...
    parser.add_argument('--init',type=int,default=1,help='Whether to init the conv layers. Default: True.')
    ...
    parser.add_argument('--surrogate_param',type=float,default=1.0,help='Hyperparameter of the surrogate function. Default: 1.0.')
    ...
    if args.dataset=='MNIST':
        ...
        train_data_loader,test_data_loader,input_shape=load_dataset_ncaltech101(args.T,experiment_path+'/data',args.batch_size,True)
        args.label_size=101
        args.expend_time=False
        if args.topology=='VGGSNN':
            args.model='VGGSNN'
