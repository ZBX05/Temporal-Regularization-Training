...
def events_to_frames(filename, dt):
    ...
    for i in range(10):
        ...
        frames[i, events[r1:r2, 5], events[r1:r2, 3], events[r1:r2, 4]] += 1
...
def create_npy():
    train_filename = 'E:/CIFAR10-DVS/train/{}.pt'
    test_filename = 'E:/CIFAR10-DVS/test/{}.pt'
    if not os.path.exists('E:/CIFAR10-DVS/train'):
        os.mkdir('E:/CIFAR10-DVS/train')
    if not os.path.exists('E:/CIFAR10-DVS/test'):
        os.mkdir('E:/CIFAR10-DVS/test')

    train_test_portion = 0.9

    fns_train = gather_addr('E:/CIFAR10-DVS/dvs-cifar10', 0, int(train_test_portion * 1000))
    fns_test = gather_addr('E:/CIFAR10-DVS/dvs-cifar10', int(train_test_portion * 1000), 1000)
